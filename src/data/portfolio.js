...
export const IMPACT_STORIES = [
  {
    ...
    description:
      'Own the target-state architecture connecting silicon validation, manufacturing, telemetry, automation, and SaaS data through a governed Lakehouse with Data Mesh and Data Fabric overlays—then out to the GPU clusters where models are trained, tuned, and served.',
    outcomes: [
      { value: '2 PB', label: 'telemetry / quarter' },
      { value: '<1 ms', label: 'p9999 serving latency' },
      { value: '60%', label: 'less manual triage' },
    ],
    stack: ['Databricks', 'Snowflake', 'Kafka', 'Aerospike', 'Trino', 'LangGraph', 'ROCm', 'vLLM'],
  },
  {
    id: 'transunion',
    index: '02',
...
export const EXPERIENCES = [
  {
    ...
    highlights: [
      ...
      'Architect the GPU-accelerated AI layer on multi-node ROCm and HPC clusters: distributed training, parameter-efficient fine-tuning, and high-throughput vLLM inference serving.',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Architected a multi-cloud MLOps serving plane with GPU-backed inference endpoints that generated $1M+ in net-new annual product revenue.',
    ],
  },
  {
    id: 'amazon',
...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    description:
      'The full model lifecycle: distributed GPU training, parameter-efficient fine-tuning, retrieval grounding, evaluation, and serving that holds its latency budget.',
    items: [
      'Claude',
      'OpenAI',
      'LangChain',
  ...
  },
  {
    ...
    description:
      'Multi-cloud and HPC foundations shaped for latency, throughput, resilience, security, and ownership.',
    items: [
      'AWS',
      'GCP',
      'Azure',
